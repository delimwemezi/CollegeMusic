...
<head>
    ...
    <title id="authPageTitle"><?php if($activeState === 'register'): ?> Create Account <?php else: ?> Login <?php endif; ?> | CollegeMusic Distribution</title>
...
<body>
    <div class="auth-split-wrapper <?php echo e($activeState === 'register' ? 'active-register' : 'active-login'); ?>" id="authWrapper">
        ...
        <div class="auth-form-panel register-panel">
            <div class="auth-split-form-box">
                ...
                <?php if(session('success') && $activeState === 'register'): ?>
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" class="auth-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="reg_name" name="name" class="form-input" placeholder="e.g. John Doe" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="reg_email" name="email" class="form-input" placeholder="e.g. john@example.com" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="reg_phone" name="phone" class="form-input" placeholder="e.g. +1234567890" value="<?php echo e(old('phone')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="reg_role" name="role" class="form-select" required>
                            <option value="artist" <?php echo e(old('role') == 'artist' ? 'selected' : ''); ?>>Artist</option>
                            <option value="record_label" <?php echo e(old('role') == 'record_label' ? 'selected' : ''); ?>>Record Label</option>
                            <option value="distributor" <?php echo e(old('role') == 'distributor' ? 'selected' : ''); ?>>Distributor</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="reg_password" name="password" class="form-input" placeholder="••••••••" required>
                        <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <?php if($activeState === 'register'): ?>
                                <span class="invalid-feedback"><?php echo e($message); ?></span>
                            <?php endif; ?>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="reg_password_confirmation" name="password_confirmation" class="form-input" placeholder="••••••••" required>
                    </div>
                ...
                <div class="auth-switch-text">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="switch-link" id="switchToLogin">Sign In</a>
                </div>
            </div>
        </div>
        ...
        <div class="auth-form-panel login-panel">
            <div class="auth-split-form-box">
                ...
                <?php if(session('success') && $activeState === 'login'): ?>
                    <div class="alert alert-success animate-fade-up">
                        <i class="fa-solid fa-circle-check"></i>
                        <span><?php echo e(session('success')); ?></span>
                    </div>
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" class="auth-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="login_field" name="login" class="form-input" placeholder="e.g. john@example.com or +1234567" value="<?php echo e(old('login')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                            ...
                            <a href="<?php echo e(route('recover.show')); ?>" style="font-size: 0.85rem; font-weight: 500; color: var(--primary);">Forgot password?</a>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="auth-switch-text">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="switch-link" id="switchToRegister">Create an Account</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Route URLs
            const LOGIN_PATH = "<?php echo e(route('login')); ?>";
            const REGISTER_PATH = "<?php echo e(route('register')); ?>";
...
<?php /**PATH C:\wamp64\www\College-Music\resources\views/auth/shared_auth.blade.php ENDPATH**/ ?>