<?php $__env->startSection('title', 'Streaming Stats'); ?>
<?php $__env->startSection('header_title', 'Analytics Dashboard'); ?>
...
<div class="page-header">
    ...
    <div>
        <div style="display: flex; gap: 0.5rem;">
            <a href="<?php echo e(route('analytics.report', ['period' => 'monthly'])); ?>" target="_blank" class="btn btn-secondary">
                <i class="fa-solid fa-file-invoice"></i> Generate Monthly Report
            </a>
            <a href="<?php echo e(route('analytics.report', ['period' => 'yearly'])); ?>" target="_blank" class="btn btn-secondary">
...
<div class="grid-stats">
    ...
    <div class="stat-card">
        <div>
            ...
            <div class="stat-value"><?php echo e(number_format($totalDownloads)); ?></div>
...
<div class="grid-cols-2">
            ...
            <?php else: ?>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $topSongs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $song): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td style="font-weight: bold;"><?php echo e($song->title); ?></td>
                                    <td style="font-family: monospace; font-size: 0.8rem;"><?php echo e($song->isrc); ?></td>
                                    <td style="text-align: right; font-weight: bold; color: var(--primary);"><?php echo e(number_format($song->streams_count)); ?></td>
                                    <td style="text-align: right; color: var(--text-secondary);"><?php echo e(number_format($song->downloads_count)); ?></td>
                                </tr>
    ...
    <div class="card" style="position: relative;">
        ...
        <div class="card-body" style="padding: 0; min-height: 250px; position: relative;">
            ...
            <!-- Table content -->
            <div class="table-responsive <?php echo e(!$isPremium ? 'premium-blur' : ''); ?>" style="transition: filter 0.3s ease;">
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $countryStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="font-weight: 500;">
                                    <i class="fa-solid fa-location-dot" style="color: var(--primary); margin-right: 0.5rem;"></i>
                                    <?php if($cnt->country === 'US'): ?> United States
                                    <?php elseif($cnt->country === 'GB'): ?> United Kingdom
                                    <?php elseif($cnt->country === 'CA'): ?> Canada
                                    <?php elseif($cnt->country === 'NG'): ?> Nigeria
                                    <?php elseif($cnt->country === 'JP'): ?> Japan
                                    <?php else: ?> <?php echo e($cnt->country); ?>

                                    <?php endif; ?>
                                </td>
                                <td style="text-align: right; font-weight: bold;"><?php echo e(number_format($cnt->total_streams)); ?></td>
                                <td style="text-align: right; color: var(--success); font-weight: 600;">$<?php echo e(number_format($cnt->total_revenue, 2)); ?></td>
                            </tr>
            ...
            <?php if(!$isPremium): ?>
                <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(21, 31, 50, 0.7); backdrop-filter: blur(5px); display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem; text-align: center; z-index: 10;">
                    ...
                    <a href="<?php echo e(route('finance')); ?>" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\College-Music\resources\views/analytics/index.blade.php ENDPATH**/ ?>