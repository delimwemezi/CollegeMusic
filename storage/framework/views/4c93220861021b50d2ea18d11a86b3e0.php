...
<body>
    ...
    <nav class="navbar">
        <div class="container navbar-content">
            ...
            <ul class="nav-links">
                <li><a href="#features" class="nav-link"><?php echo e(__('messages.features')); ?></a></li>
                <li><a href="#platforms" class="nav-link"><?php echo e(__('messages.platforms')); ?></a></li>
                <li><a href="#pricing" class="nav-link"><?php echo e(__('messages.pricing')); ?></a></li>
                <li><a href="<?php echo e(route('explore')); ?>" class="nav-link" style="color: var(--primary); font-weight: bold;"><i class="fa-solid fa-compass"></i> <?php echo e(__('messages.explore_music')); ?></a></li>
            </ul>
            <div class="nav-actions" style="display: flex; align-items: center; gap: 1rem;">
                ...
                <a href="<?php echo e(route('login')); ?>" class="nav-link" style="margin-right: 0.25rem; font-weight: 600;"><?php echo e(__('messages.sign_in')); ?></a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary" style="padding: 0.55rem 1.25rem; font-size: 0.85rem;"><?php echo e(__('messages.get_started')); ?></a>
            </div>
        </div>
    </nav>
    ...
    <header class="hero">
        ...
        <div class="container hero-grid" style="position: relative; z-index: 5;">
            <div>
                <h1 class="hero-title"><?php echo e(__('messages.distribute_globally_title')); ?></h1>
                <p class="hero-subtitle">
                    <?php echo e(__('messages.hero_subtitle')); ?>

                </p>
                <div class="hero-actions">
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary"><i class="fa-solid fa-play"></i> <?php echo e(__('messages.distribute_now')); ?></a>
                    <a href="#features" class="btn btn-secondary"><?php echo e(__('messages.learn_more')); ?></a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="stats-bar">
                <div>
                    <div class="stat-item-title"><?php echo e(__('messages.stats_creators')); ?></div>
                    <div class="stat-item-val">12K+</div>
                </div>
                <div style="border-left: 1px solid var(--border-color);"></div>
                <div>
                    <div class="stat-item-title"><?php echo e(__('messages.stats_platforms')); ?></div>
                    <div class="stat-item-val">150+</div>
                </div>
                <div style="border-left: 1px solid var(--border-color);"></div>
                <div>
                    <div class="stat-item-title"><?php echo e(__('messages.stats_royalties')); ?></div>
    ...
    <section class="platforms-section" id="platforms">
        <div class="container">
            <h3 class="platforms-title"><?php echo e(__('messages.partnership_title')); ?></h3>
    ...
    <section class="features" id="features">
        <div class="container">
            <div class="section-header">
                <span class="section-tag"><?php echo e(__('messages.features_tag')); ?></span>
                <h2 class="section-heading"><?php echo e(__('messages.features_heading')); ?></h2>
                <p class="section-desc"><?php echo e(__('messages.features_desc')); ?></p>
            </div>
            
            <div class="features-grid">
                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-earth-americas"></i></div>
                    <h3 class="feature-title"><?php echo e(__('messages.feat_global_title')); ?></h3>
                    <p class="feature-desc"><?php echo e(__('messages.feat_global_desc')); ?></p>
                </div>
                
                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-chart-simple"></i></div>
                    <h3 class="feature-title"><?php echo e(__('messages.feat_analytics_title')); ?></h3>
                    <p class="feature-desc"><?php echo e(__('messages.feat_analytics_desc')); ?></p>
                </div>
                
                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-wallet"></i></div>
                    <h3 class="feature-title"><?php echo e(__('messages.feat_royalties_title')); ?></h3>
                    <p class="feature-desc"><?php echo e(__('messages.feat_royalties_desc')); ?></p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-wand-magic-sparkles"></i></div>
                    <h3 class="feature-title"><?php echo e(__('messages.feat_wizard_title')); ?></h3>
                    <p class="feature-desc"><?php echo e(__('messages.feat_wizard_desc')); ?></p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-users-gear"></i></div>
                    <h3 class="feature-title"><?php echo e(__('messages.feat_label_title')); ?></h3>
                    <p class="feature-desc"><?php echo e(__('messages.feat_label_desc')); ?></p>
                </div>

                <div class="feature-card">
                    <div class="feature-icon"><i class="fa-solid fa-file-shield"></i></div>
                    <h3 class="feature-title"><?php echo e(__('messages.feat_audit_title')); ?></h3>
                    <p class="feature-desc"><?php echo e(__('messages.feat_audit_desc')); ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="steps-section">
        <div class="container">
            <div class="section-header">
                <span class="section-tag"><?php echo e(__('messages.how_tag')); ?></span>
                <h2 class="section-heading"><?php echo e(__('messages.how_heading')); ?></h2>
                <p class="section-desc"><?php echo e(__('messages.how_desc')); ?></p>
            </div>
            ...
            <div class="steps-grid">
                <div class="step-item">
                    ...
                    <h3 class="step-title"><?php echo e(__('messages.how_step1_title')); ?></h3>
                    <p class="step-desc"><?php echo e(__('messages.how_step1_desc')); ?></p>
                </div>
                
                <div class="step-item">
                    <div class="step-num">02</div>
                    <div class="step-icon"><i class="fa-solid fa-tower-broadcast"></i></div>
                    <h3 class="step-title"><?php echo e(__('messages.how_step2_title')); ?></h3>
                    <p class="step-desc"><?php echo e(__('messages.how_step2_desc')); ?></p>
                </div>
                
                <div class="step-item">
                    <div class="step-num">03</div>
                    <div class="step-icon"><i class="fa-solid fa-dollar-sign"></i></div>
                    <h3 class="step-title"><?php echo e(__('messages.how_step3_title')); ?></h3>
                    <p class="step-desc"><?php echo e(__('messages.how_step3_desc')); ?></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pricing" id="pricing">
        <div class="container">
            <div class="section-header">
                <span class="section-tag"><?php echo e(__('messages.pricing_tag')); ?></span>
                <h2 class="section-heading"><?php echo e(__('messages.pricing_heading')); ?></h2>
                <p class="section-desc"><?php echo e(__('messages.pricing_desc')); ?></p>
            </div>
            ...
            <div class="pricing-grid">
                ...
                <div class="price-card">
                    <div class="price-header">
                        <div class="price-name"><?php echo e(__('messages.pricing_free_title')); ?></div>
                    ...
                    <ul class="price-features">
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_free_feat1')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_free_feat2')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_free_feat3')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_free_feat4')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_free_feat5')); ?></li>
                    </ul>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary price-btn"><?php echo e(__('messages.get_started')); ?></a>
                </div>
                
                <!-- Plan 2 -->
                <div class="price-card featured">
                    <span class="price-badge"><?php echo e(__('messages.pricing_premium_badge')); ?></span>
                    <div class="price-header">
                        <div class="price-name"><?php echo e(__('messages.pricing_premium_title')); ?></div>
                        <div class="price-cost"><?php echo e(__('messages.pricing_premium_cost')); ?><span>/year</span></div>
                        <p style="color: var(--text-secondary); font-size: 0.8rem; margin-top: 0.5rem;">Unlimited free distributions</p>
                    </div>
                    <ul class="price-features">
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <strong><?php echo e(__('messages.pricing_premium_feat1')); ?></strong></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <strong><?php echo e(__('messages.pricing_premium_feat2')); ?></strong></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_premium_feat3')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_premium_feat4')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_premium_feat5')); ?></li>
                    </ul>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary price-btn"><?php echo e(__('messages.upgrade_account')); ?></a>
                </div>
                
                <!-- Plan 3 -->
                <div class="price-card">
                    <div class="price-header">
                        <div class="price-name"><?php echo e(__('messages.pricing_label_title')); ?></div>
                        <div class="price-cost"><?php echo e(__('messages.pricing_label_cost')); ?><span>/year</span></div>
                        <p style="color: var(--text-secondary); font-size: 0.8rem; margin-top: 0.5rem;">Multi-artist management catalog</p>
                    </div>
                    <ul class="price-features">
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_label_feat1')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_label_feat2')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_label_feat3')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_label_feat4')); ?></li>
                        <li class="price-feature-item"><i class="fa-solid fa-check"></i> <?php echo e(__('messages.pricing_label_feat5')); ?></li>
                    </ul>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary price-btn"><?php echo e(__('messages.register_label')); ?></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="testimonials" id="testimonials">
        <div class="container">
            <div class="section-header">
                <span class="section-tag"><?php echo e(__('messages.success_stories')); ?></span>
                <h2 class="section-heading"><?php echo e(__('messages.testimonials')); ?></h2>
                <p class="section-desc"><?php echo e(__('messages.success_stories')); ?></p>
            </div>
    ...
    <section class="cta-section">
        <div class="container">
            <div class="cta-box">
                <h2 class="cta-title"><?php echo e(__('messages.ready_share')); ?></h2>
                <p class="cta-desc">Join thousands of artists and record labels who trust CollegeMusic to grow their music careers.</p>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-primary"><i class="fa-solid fa-rocket"></i> <?php echo e(__('messages.create_account')); ?></a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-grid">
                <div>
                    ...
                    <p class="footer-desc"><?php echo e(__('messages.footer_tagline')); ?></p>
                ...
                <div>
                    <h4 class="footer-col-title"><?php echo e(__('messages.footer_col_distribute')); ?></h4>
                ...
                <div>
                    <h4 class="footer-col-title"><?php echo e(__('messages.footer_col_features')); ?></h4>
                    <ul class="footer-menu">
                ...
                <div>
                    <h4 class="footer-col-title"><?php echo e(__('messages.footer_col_legal')); ?></h4>
                    <ul class="footer-menu">
            ...
            <div class="footer-bottom">
                <span>&copy; 2026 CollegeMusic Inc. <?php echo e(__('messages.all_rights_reserved')); ?> Made for independent music developers.</span>
...
<?php /**PATH C:\wamp64\www\College-Music\resources\views/welcome.blade.php ENDPATH**/ ?>