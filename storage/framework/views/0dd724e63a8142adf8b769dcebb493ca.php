...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Explore Music'); ?> | CollegeMusic</title>
...
<body>
    ...
    <nav class="navbar">
        <div class="container navbar-content">
            ...
            <ul class="nav-links">
                <li><a href="<?php echo e(route('home')); ?>#features" class="nav-link"><?php echo e(__('messages.features')); ?></a></li>
                <li><a href="<?php echo e(route('home')); ?>#platforms" class="nav-link"><?php echo e(__('messages.platforms')); ?></a></li>
                <li><a href="<?php echo e(route('home')); ?>#pricing" class="nav-link"><?php echo e(__('messages.pricing')); ?></a></li>
                <li><a href="<?php echo e(route('explore')); ?>" class="nav-link <?php echo e(Request::routeIs('explore') ? 'active' : ''); ?>" style="color: var(--primary); font-weight: bold;"><i class="fa-solid fa-compass"></i> <?php echo e(__('messages.explore_music')); ?></a></li>
            </ul>
            <div class="nav-actions">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary btn-sm" style="padding: 0.55rem 1.25rem; font-size: 0.85rem;">
    ...
    <footer>
        <div class="container">
            ...
            <p style="color: var(--text-secondary); font-size: 0.85rem; margin-bottom: 0.5rem;">
                <?php echo e(__('messages.footer_tagline')); ?>

            </p>
            <p style="color: var(--text-muted); font-size: 0.75rem;">
                &copy; <?php echo e(date('Y')); ?> CollegeMusic. <?php echo e(__('messages.all_rights_reserved')); ?>
...
<?php /**PATH C:\wamp64\www\College-Music\resources\views/layouts/public.blade.php ENDPATH**/ ?>